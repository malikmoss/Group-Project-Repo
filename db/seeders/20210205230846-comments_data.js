		...
		await queryInterface.bulkInsert(
			...
			[
				...
				},
				{
					...
					authorId: getAuthId(),
					body:
						"Don't want to close my eyes I don't want to fall asleep Cause I'd miss you babe And I don't want to miss a thing Cause even when I dream of you The sweetest dream will never do I'd still miss you babe And I dont want to miss a thing.",
					createdAt: new Date(),
					updatedAt: new Date(),
				},
				{
					answerId: getAnswerId(),
					authorId: getAuthId(),
					body: "Please allow me to introduce myself I'm a man of wealth and taste I've been around for a long, long year Stole many a mans soul and faith And I was round when jesus christ Had his moment of doubt and pain.",
					createdAt: new Date(),
					updatedAt: new Date(),
				},
				...
				},
				{
					answerId: getAnswerId(),
					authorId: getAuthId(),
					body: "Now this is the story all about how My life got flipped, turned upside down And I'd like to take a minute just sit right there I'll tell you how I became the prince of a town called Bel-air.",
					createdAt: new Date(),
					updatedAt: new Date(),
				},
				{
				...
				},
				{
					answerId: getAnswerId(),
					authorId: getAuthId(),
					body: "People always told me be careful of what you do And dont go around breaking young girls' hearts And mother always told me be careful of who you love And be careful of what you do cause the lie becomes the truth.",
					createdAt: new Date(),
					updatedAt: new Date(),
				},
				{ answerId: getAnswerId(), authorId: getAuthId(), body: 'And everything is going to the beat And everything is going to the beat And everything is going...', createdAt: new Date(), updatedAt: new Date() },
				...
				{ answerId: getAnswerId(), authorId: getAuthId(), body: 'Microsoft bought Skype for 8,5 billion!.. what a bunch of idiots! I downloaded it for free!', createdAt: new Date(), updatedAt: new Date() },
				{
					answerId: getAnswerId(),
					authorId: getAuthId(),
					body: "Sorry, I can't hangout. My uncle's cousin's sister in law's best friend's insurance agent's roommate's pet goldfish died. Maybe next time.",
					createdAt: new Date(),
					updatedAt: new Date(),
				},
